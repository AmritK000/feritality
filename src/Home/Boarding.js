  ...
  const getList = async () => {
    ...
    try {
      ...
      if (listData?.status === true) {
        setBoardingList(listData.result);
      }
    } catch (error) {
            ...
            <div className="slide-item" key={index}>
              <div className="grooming_board">
                <div className="grooming_board_cardbox">
                  ...
                  <img src={`${ASSETS_BASE_URL}${item?.image}`} alt={item?.image} width={`100px`} />
                  </Link>
                ...
                <div className="">
                  ...
                  <Link to={`https://www.google.com/maps/dir/?api=1&destination=${BoardingList?.latitude},${BoardingList?.longitude}`}
                        target="_blank"

...
const VetrinaryListing = () => {
    ...
    *********************************************************/
    const vetrinaryShopList = async () => {
        ...
        try {
            ...
            console.log("Failed to fetch vetrinary shop list: ", error)
        }
    }
    ...
    *********************************************************/
    useEffect(() => {
        ...
        document.title = "Frisbee website || Vetrinary store list"
    }, [currentPage])
                    ...
                    {ShopList?.length > 0 ? (ShopList.map((item, index) => (
                        <>
                            <div className="avenue_pet" key={index}>
                                ...
                                <div>
                                    <Link to={`/services/veterinary/${item?._id} `}>
...
export default VetrinaryListing;

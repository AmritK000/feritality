...
import { details as dayCare_services } from "../../../controllers/services/dayCareController";
        ...
        try {
            ...
            if (listData?.status === true) {
                ...
                if (listData.result?.storeData?._id && listData.result?._id) {
                    ...
                    const dayCareData = await dayCare_services(dayCareOptions);
                    // console.log("dayCareData services", dayCareData)
                    if (dayCareData?.status === true) {
                        setStoreDetails(prevDetails => ({
                            ...prevDetails,
                            dayCareServices: dayCareData.result
                        }));
                    } else {
    ...
    *********************************************************/
    ...
    return (
        <>
            ...
            {/* Daycare service section */}
            <div className="">
                <div className="container">
                    <div className="row">
                        <div className="col-md-3">
                            <InnerServiceSidebar slug="day-care" vendorData={StoreDetails?.vendorData} storeId={StoreDetails?._id} StoreDetails = {StoreDetails} category ={categoryId}/>
                        </div>
                        <div className="col-md-9 grooming_info">
                            <BookedServiceslider />
                            <div className="features_grooming ">
                                <h1 className="main_heading" ><span>DayCare </span> Service</h1>
                                <p className="sub_heading">It is a long established fact that a reader will be distracted by the readable content</p>
                            </div>

                            {StoreDetails?.dayCareServices?.length > 0 ? (
                                StoreDetails.dayCareServices.map((item, index) => (
...
export default DayCareStoredetails;
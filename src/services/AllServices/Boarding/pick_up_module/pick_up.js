...
import {
  breedList,
  addEditAddress,
} from "../../../../controllers/accounts/Account.js";
...
const Boardingservice = () => {
  ...
  const handlePickupTimeChange = (event) => {
    setPickupTime(event.target.value); // Update the pickup time in the state
  }; //end

  /*********************************************************
   *  This function is use to handle the change for drop time
   *********************************************************/
  const handleDropTimeChange = (event) => {
    setDropTime(event.target.value); // Update the pickup time in the state
  }; //end
  ...
  /*********************************************************
   *  This function is used to toggle one-way
   *********************************************************/
  ...
  /*********************************************************
   *  This function is used to toggle two-way
   *********************************************************/
  ...
  /*****************************************************************************
   *  This function is used to Handle Data required to get before entering checkout
   ********************************************************************************/
  const store_process = (e) => {
    ...
    navigate("/services/boarding/pick-drop/checkout");
  }; // end
                      ...
                      <div className="location_es">
                        <div className="location_Center">
                          <input
                            ...
                            onChange={handlePickupTypeChange} // Handle selection change
                            checked={pickupType === "User location to centre"} // Check if this option is selected
                          />
                        ...
                        <div className="location_Center">
                          <input
                            ...
                            onChange={handlePickupTypeChange} // Handle selection change
                            checked={pickupType === "Centre to user location"} // Check if this option is selected
                          />
                          ...
                          <div key={index} className="addnew_address mb-3">
                            <div>
                              <input
                                ...
                                name="address"
                                value={index}
                                onChange={() => handleAddressChange(index)} // Handle address selection
                                checked={selectedAddress === ADMININFO[index]} // Ensure the correct radio button is selected
                              />

...
} from "../../../../controllers/services/groomingController";
                  ...
                  {data?.servive_type === "Pick & Drop" && (
                    <li>
                      ...
                      <p className="text-end">
                        AED {data?.pick_drop_charges?.toFixed(2)? data?.pick_drop_charges?.toFixed(2): "0"}
                      </p>
                    </li>
                  )}
                  <li><span>Treats used (100)</span><p>AED {data?.treats_discount ? data?.treats_discount : "0"}</p></li>
